#' The Double Super Learner Method (DSL): Continuous Case Treatment
#' @description  Estimates the treatment effect using the DSL method when the treatment variable is considered to be continuous.
#' @export
...
#' DSL1(data=DataSet, y.col.n=1, d.col.n=2, SL.library=SL.library, cv=3L)

DSL1 <- function(data, y.col.n, d.col.n, SL.library, cv) {
  R=y.col.n
  Tr=d.col.n
  N=nrow(data)
  DAT=data
