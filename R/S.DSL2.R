#' The Selected Double Super Learner Method (SDSL): Binary Case Treatment
#' @description  Estimates the treatment effect using the selected DSL method when the treatment variable is considered to be binary.
#' @export
...
#' S.DSL2(data=DataSet, y.col.n=1, d.col.n=2, SL.library=SL.library, cv=3L, Best.Yt=1, Best.Ytr=1, Best.Dt=5, Best.Dtr=5)


S.DSL2 <- function(data, y.col.n, d.col.n, SL.library, cv, Best.Yt, Best.Ytr, Best.Dt, Best.Dtr ) {
  R=y.col.n
  Tr=d.col.n
  N=nrow(data)
  DAT=data
